...
/*   Updated: 2024/02/02 12:56:12 by juestrel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							ft_print_lower_hex(unsigned int hexa,
								unsigned int *i);
int							ft_print_upper_hex(unsigned int hexa,
								unsigned int *i);
int							ft_print_uns_base10(unsigned int number,
								unsigned int *i);
